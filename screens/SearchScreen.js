...
import { View, Text, ScrollView, TouchableOpacity, Image, Platform, TextInput, TouchableWithoutFeedback, Dimensions } from 'react-native';
        ...
        <LinearGradient className="flex-1" colors={["#06141b", "#11212d"]} locations={[0.2, 1]}>
...

            {
                results.length > 0 ? (
                    ...
                    >
                        <Text className="text-white font-semibold mb-4">Results ({results.length})</Text>
                    ...
                    <View className="flex-1 flex-row justify-center items-center">
                        <Text className="text-neutral-500">No results for searching movies</Text>
                    </View>
                )
            }
        </LinearGradient>
